...
console.log(div.style.backgroundColor); // Accessing the background color style of the <div> element
console.log(div.style.fontSize); // Accessing the font size style of the <div>
console.log(setInterval.style.fontWeight = 9px); // Accessing the font weight style of the <div>