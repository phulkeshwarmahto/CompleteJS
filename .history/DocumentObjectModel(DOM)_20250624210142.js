...
console.log(heading2.innerText = "Welcome to my website"); // Accessing the inner text of the <h1> element
console.log(heading2.textContent = "Welcome to my website"); // Modifying the text content of the <h2> element