...
// element tags
let divs = document.getElementsByTagName("div"); // Accessing all <div> elements in the document
console.dir(divs); // Logging the HTMLCollection of <div> elements
console.log(divs); // Logging the HTMLCollection of <div> elements