...
let heading = document.querySelector("h1"); // Selecting the first <h2> element
console.log(heading.textContent = "Welcome to my website"); // Modifying the text content of the <h2> element