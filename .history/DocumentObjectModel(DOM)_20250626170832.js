...
let para = document.querySelector("p");
para.append(button); // Appending the button to the first paragraph element
console.log(para); // Logging the paragraph element after appending the button
...
console.log(button.style.backgroundColor = "lightblue"); // Setting the background color style of the button