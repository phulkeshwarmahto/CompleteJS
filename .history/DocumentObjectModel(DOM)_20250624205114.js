...
console.log(div.textContent); // Accessing the text content of the <div> element
...
console.log(heading.innerText = 2.Welcome to my we); // Accessing the inner text of the <h2> element