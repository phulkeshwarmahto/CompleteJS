...
// let setId = div.setAttribute("id","newId");

// console.log(setId); // Setting a new id attribute for the <div> element
// let setName = div.setAttribute("name","newName");
// console.log(setName); // Setting a new name attribute for the <div> element


// let div = document.querySelector("div");
// console.log(div.style); // Accessing the style property of the <div> element
// console.log(div.style.color); // Accessing the color style of the <div> element   
// console.log(div.style.fontSize); // Accessing the font size style of the <div>
// console.log(div.style.fontWeight); // Accessing the font weight style of the <div>
// console.log(div.style.backgroundColor = "lightgreen"); //  Setting the background color style of the <div> element
// console.log(div.style.fontSize = "20px"); // Setting the font size style of the <div> element
// console.log(div.style.fontWeight = "bold"); // Setting the font weight style of the <div> element
...
// let div = document.querySelector("div");
// div.prepend(btn); // Appending the button to the <div> element
// div.after("btn")
// // console.log(div); // Logging the <div> element after appending the button  
...
// para.remove(); // Removing the first paragraph element from the document
// console.log(para); // Logging the removed paragraph element

// heading.remove(); // Removing the newly created heading element from the document
// console.log(heading); // Logging the removed heading element
...
// console.log(button.style); // Accessing the style property of the button
// console.log(button.style.color ="white"); // Accessing the color style of the button
// console.log(button.style.backgroundColor = "red"); // Setting the background color style of the button

//practice
let para = document.querySelector("p"); // Selects the first <p> element

para.getAttribute("myP"); 
// Retrieves the value of the "myH" attribute, if it exists
// But this line alone does nothing unless you use the return value

para.setAttribute("myP", "newclass"); 
// Sets or updates the "myH" attribute of the <p> element to "newclass"

para.classList.add("newclass"); 
// Adds a class named "newClass" to the <p> element’s class list

// para.classList.remove("para"); // Removing the "para" class from the paragraph element

para.classList.toggle("newclass");
// Toggles the "newclass" class on the <p> element, adding it if it’s not present, or removing it if it is    
para.removeAttribute("myP");
// Removes the "myH" attribute from the <p> element, if it exists